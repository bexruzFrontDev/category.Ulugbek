...
const Laptops = rezerApi.filter((el) => el.category === "Laptop")
function Htmlga1() {
  let html = ''
  Laptops.map((el) => {
      html += `
...
const Mice = rezerApi.filter((el) => el.category === "MICE")
function Htmlga2() {
  let html = ''
  Mice.map((el) => {
      html += `
...
const Keyboards = rezerApi.filter((el) => el.category === "Keyboards")
function Htmlga3() {
  let html = ''
  Keyboards.map((el) => {
      html += `
...
const Headsets = rezerApi.filter((el) => el.category === "Headsets")
function Htmlga4() {
  let html = ''
  Headsets.map((el) => {
      html += `
...
const Streaming = rezerApi.filter((el) => el.category === "Streaming")
function Htmlga5() {
  let html = ''
  Streaming.map((el) => {
      html += `
...
const Chairs = rezerApi.filter((el) => el.category === "Chairs")
function Htmlga6() {
  let html = ''
  Chairs.map((el) => {
      html += `
...
const Console = rezerApi.filter((el) => el.category === "Console")
function Htmlga7() {
  let html = ''
  Console.map((el) => {
      html += `
...
const Mobile = rezerApi.filter((el) => el.category === "Mobile")
function Htmlga8() {
  let html = ''
  Mobile.map((el) => {
      html += `
...
const Gear = rezerApi.filter((el) => el.category === "Gear")
function Htmlga9() {
  let html = ''
  Gear.map((el) => {
      html += `
